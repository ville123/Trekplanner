...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public List<Item> getItems(Long trekId) {
        ...
        item.setStatus("item_status_1");
        item.setType("item_type_1");
    ...
    private void insertItem(Item item){
        ...
        // TODO: Note! no need for this, this is the same than addItem
    ...
    public List<TrekItem> getTrekItems(Long trekId) {
        ...
        List<TrekItem> titems = new ArrayList<>();
        titems.add(titem);
        return titems;
    }
